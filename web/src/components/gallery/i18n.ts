...
export const T: Record<Lang, Dict> = {
  en: {
    ...
    preview: "Photographer preview — nothing you do here is saved to the client’s selection.",
  ...
  id: {
    ...
    preview: "Pratinjau fotografer — tidak ada yang tersimpan ke pilihan klien.",
