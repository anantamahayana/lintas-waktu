  ...
  return (
    <div>
      ...
      <section className="wrap gutter pt-12 lg:pt-20 pb-16 lg:pb-24 grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
        <Reveal className="lg:col-span-5 aspect-[4/5]" style={boxStyle(fr["about-portrait"])}>
          <Photo src={img["about-portrait"]} seed="about-portrait" frame={fr["about-portrait"] && { ...fr["about-portrait"], fit: "cover" }} priority sizes="(min-width:1024px) 40vw, 100vw" className="h-full w-full" />
        </Reveal>
      ...
      <section className="wrap gutter py-16 lg:py-24 grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        {["about-1", "about-2", "about-3", "about-4"].map((s, i) => (
          <Reveal key={s} delay={i * 70} className="aspect-[3/4]" style={boxStyle(fr[s])}>
            <Photo src={img[s]} seed={s} frame={fr[s] && { ...fr[s], fit: "cover" }} sizes="(min-width:1024px) 25vw, 50vw" className="h-full w-full" />
          </Reveal>
        ))}
      </section>
